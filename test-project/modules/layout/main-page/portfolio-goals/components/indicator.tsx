    ...
    return ( 
        <div className="flex flex-col text-white"> 
            ...
            <div className="flex gap-[20px]">
                <div className="flex text-white max-w-[197px] w-full h-[28px] bg-[rgb(49,56,83)] gap-[20px] rounded-r-2xl">
                    <div className="text-right pr-[10px] w-full max-w-[100px] h-[100%] rounded-r-2xl" 
                        style={{backgroundImage:"linear-gradient(90deg, #1e3a8a 0%, #2563eb 100%)"}}>
