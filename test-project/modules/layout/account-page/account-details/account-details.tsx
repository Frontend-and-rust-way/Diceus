...
//           <div className="flex flex-col pr-[20px]  border-r-2 border-dashed border-gray-600">
//               <CardSupport />
//               {riskAssessmentData.map((item, index) => (
//                 <div key={index} className="flex justify-between my-[20px] mx-[50px] text-[16px] text-white lg:text-[25px]"> 
//                   <span className="text-white">{item.title}</span>   
//                   <div className="bg-gray-800 text-white flex items-center justify-center border-white border-2 rounded-2xl w-10 h-10"> {/* Зроблено div квадратним */}
//                     {item.value}
//                   </div>
//                 </div>
//               ))}
...
//             <span className="text-white text-[40px]">Winnability</span>
...
//           <span className="text-[30px] text-white">DECISION SUPPORT</span>
...
//         <div className="flex flex-col gap-[10px]  pl-[15px] lg:pl-[40px]">
//             {spans.map((span, i) => (
//               <span key={span.span} className={cn("text-[16px]", i === 0 ? "text-tw-light-blue" : "text-white")}>{span.span}</span>
//             ))}
//         </div>        
//     </CardWrapper>
//   )
...
//               <span className="text-white">{item.recommendation}</span>
//               <div className="flex justify-betwee mt-[5px] ">
//                 <span className="max-w-[817px] text-gray-500 w-full">{item.details}</span>
//                 <button className="max-w-[127px] h-[40px] bg-green-600 w-full rounded-2xl text-black">
//                   {item.action}
//                 </button>
//               </div>
//             </div>
...
// export function WinnabilityAnaliz({
//   title,
//   iconType,
//   color,
//   data,
// }: IWinnabilityAnalizProps) {
...
//   return (
//     <CardWrapper className="w-full gap-[40px] bg-[#1A1D2E] p-6 rounded-xl">
//       <div className="flex gap-[20px] items-center text-white text-lg font-semibold">
//         <div
//           className={`border-2 rounded-full w-[35px] h-[35px] flex items-center justify-center ${textColor}`}
//         >
...
//           <div
//             className={cn(
//               "flex items-center justify-center max-w-[40px] w-full h-full max-h-[40px] rounded-full border-2 font-bold",
//               borderColor,
//               textColor
//             )}
//           >
...
//                 <div
//                   className="h-full transition-all duration-300 rounded-r-2xl"
//                   style={{
...
//   return (
//     <div className="flex flex-col w-[1060px] py-[30px] lg:flex-row gap-8">
//       <WinnabilityAnaliz
...
//   return (
//     <CardWrapper className="h-[151px] ">
//       <span className="text-sm text-gray-400 ">{dataHeading}</span>
//       <div className="flex items-center justify-between mt-2 gap-[20px] ]">
...
//   return (
//     <CardWrapper className="text-white max-h-[151px] gap-[10px] basis-[460px]">
//       <span className="text-base sm:text-lg  w-[80%]">Position</span>
//       <div className="flex flex-col gap-1">
//         {mockCardDescription.map((card) => (
//           <div key={card.heading} className="items-center gap-4  inline-flex max-w-[80%]">
//             <Progress className="max-w-[225px] flex-1 h-[14px]" value={card.value} />
//             <span className="text-xs sm:text-sm whitespace-nowrap">{card.heading}</span>
//           </div>
//         ))}
//       </div>
//     </CardWrapper>
...
//   return (
//     <CardWrapper className="h-[151px] text-[rgb(37,42,61)] pb-[40px]">
//       <span className=" text-sm text-gray-400 mb-2 flex">Historical trend</span>
...
//           width={300}
//           height={40}
//           className="w-full  relative top-[-20px] h-[80px] object-contain mb-[50px]"
//         />
//       </div>
//     </CardWrapper>
//   );
